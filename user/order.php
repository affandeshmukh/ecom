...
///getting total items and total items price
  ...
  $insert_query="insert into `user_order` (user_id,	amount_due,	bill_num,total_product,order_date,order_status,image ) values 
  ($user_id,$subtotal,$bill_num,$count_products,NOW(),'$status','$product_image1')";
  ...
  //order pending 
  $insert_pending="insert into `pending_order` (user_id,amount_due,bill_num,product_id,quantity,order_status ) values 
  ($user_id,$subtotal,$bill_num,$product_id,$quantity,'$status')";
